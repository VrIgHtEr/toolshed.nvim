...
a.run(function()
    if false then
        a.spawn_a({'rm', '-rf', vim.fn.stdpath('data') .. '/site/pack'})
    else
        plugtool.DEBUG_RESET()
        plugtool.setup {
            ...
            'airblade/vim-gitgutter', 'jreybert/vimagit',
            'mfussenegger/nvim-jdtls', 'williamboman/nvim-lsp-installer',
